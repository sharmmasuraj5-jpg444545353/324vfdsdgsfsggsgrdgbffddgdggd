...
@app.on_message(
    filters.command(["fsub", "oinmust", "oin", "join", "joinmust"], prefixes=["/", "!", ".", "J", "j"])
    & filters.group
)
async def set_forcesub(client: Client, message: Message):
    ...
    if not (member.status in ["creator", "administrator"] or user_id in SUDOERS):
        return await message.reply_text(
            "**🚫 ᴏɴʟʏ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴs, ᴏᴡɴᴇʀ ᴏʀ sᴜᴅᴏᴇʀs ᴄᴀɴ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ.**"
        )
    ...
    if len(message.command) != 2:
        return await message.reply_text(
            "**➻ ᴜsᴀɢᴇ :-** `/fsub <ᴄʜᴀɴɴᴇʟ_ᴜsᴇʀɴᴀᴍᴇ_ᴏʀ_ɪᴅ>` **ᴏʀ** `/fsub disable` **ᴛᴏ ᴅɪsᴀʙʟᴇ**"
        )
    ...
    try:
        ...
        if not bot_is_admin:
            return await message.reply_photo(
                ...
                caption=(
                    "**🚫 ɪ'ᴍ ɴᴏᴛ ᴀɴ ᴀᴅᴍɪɴ ɪɴ ᴛʜɪs ᴄʜᴀɴɴᴇʟ.**\n\n"
                    "**➲ ᴘʟᴇᴀsᴇ ᴍᴀᴋᴇ ᴍᴇ ᴀɴ ᴀᴅᴍɪɴ ᴡɪᴛʜ:**\n"
                    "**➥ ɪɴᴠɪᴛᴇ ɴᴇᴡ ᴍᴇᴍʙᴇʀs**\n\n"
                    "🛠️ **ᴛʜᴇɴ ᴜsᴇ** `/fsub <ᴄʜᴀɴɴᴇʟ_ᴜsᴇʀɴᴀᴍᴇ>` **ᴛᴏ sᴇᴛ ғᴏʀᴄᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ.**"
                ),
...
async def check_forcesub(client: Client, message: Message):
    ...
    try:
        ...
        await message.reply_text(
            "**🚫 I'ᴍ ɴᴏ ʟᴏɴɢᴇʀ ᴀɴ ᴀᴅᴍɪɴ ɪɴ ᴛʜᴇ ғᴏʀᴄᴇᴅ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ᴄʜᴀɴɴᴇʟ. ғᴏʀᴄᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ʜᴀs ʙᴇᴇɴ ᴅɪsᴬʙʟᴇᴅ.**"
        )

# ---------------- Enforce on every group message ----------------
...
__MODULE__ = "JᴏɪɴMᴜsᴛ"
__HELP__ = """**
/fsub <ᴄʜᴀɴɴᴇʟ_ᴜsᴇʀɴᴀᴍᴇ_ᴏʀ_ɪᴅ> - sᴇᴛ ғᴏʀᴄᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ғᴏʀ ᴛʜɪs ɢʀᴏᴜᴘ.
/fsub disable - ᴅɪsᴀʙʟᴇ ғᴏʀᴄᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ғᴏʀ ᴛʜɪs ɢʀᴏᴜᴘ.**
"""
